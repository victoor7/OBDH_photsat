...
UAHPhotSat::UAHPhotSat(TEDROOMComponentID id,
...
void UAHPhotSat::EDROOMBehaviour()
{
...
bool UAHPhotSat::EDROOMIsComponentFinished()
{
...
void UAHPhotSat::CEDROOMMemory::SetMemory(TEDROOMUInt32 numMessages_ ,
