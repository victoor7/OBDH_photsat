...
C_SRCS += \
../service_libraries/pus_services/pus_service2/src/pus_service2.c 

C_DEPS += \
./service_libraries/pus_services/pus_service2/src/pus_service2.d 

OBJS += \
./service_libraries/pus_services/pus_service2/src/pus_service2.o 


# Each subdirectory must supply rules for building sources it contributes
service_libraries/pus_services/pus_service2/src/%.o: ../service_libraries/pus_services/pus_service2/src/%.c service_libraries/pus_services/pus_service2/src/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-service_libraries-2f-pus_services-2f-pus_service2-2f-src

clean-service_libraries-2f-pus_services-2f-pus_service2-2f-src:
	-$(RM) ./service_libraries/pus_services/pus_service2/src/pus_service2.d ./service_libraries/pus_services/pus_service2/src/pus_service2.o

.PHONY: clean-service_libraries-2f-pus_services-2f-pus_service2-2f-src
